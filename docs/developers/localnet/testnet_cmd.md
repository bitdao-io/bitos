...
preparing test network with chain-id "bitos_1276974-1"
...
```bash
bitosd keys add test --recover
```

Check the balance of the account address:

```bash
bitosd q bank balances [address]
```
