...
Learn about bitos with the list of official resources. {synopsis}
...
- Documentation (this site): [https://bitos.dev/](https://bitos.dev/)
...
Learn how to run an bitos [node](./../../validators/quickstart/run_node.md) {hide}
