...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/bitos/bitos/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for bitos is hosted at [bitos.dev](https://bitos.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/bitos/bitos/tree/main/docs).
