...
Learn more about transactions on bitos {synopsis}
...
<!-- 
TODO: explain what transactions are on bitos and blockchains. 
...
<!-- TODO: explain which transactions types does bitos support (i.e modules and changes) and provide a few examples. -->
