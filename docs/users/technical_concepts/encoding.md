...
Learn about the encoding formats used on bitos. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. bitos does not
...
allows for quick reconstruction of encoded data. bitos uses RLP to encode/decode Ethereum
