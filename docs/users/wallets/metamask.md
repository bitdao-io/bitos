...
Connect your Metamask wallet with bitos {synopsis}
...
::: tip
If you are planning on developing on bitos locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](../../validators/quickstart/run_node.md), or follow the instructions in the [GitHub repository](https://github.com/bitos/bitos/).
:::
...
3. Click the `Connect Wallet` button under `bitos Testnet`
...
```bash
bitosd keys unsafe-export-eth-key mykey
```
