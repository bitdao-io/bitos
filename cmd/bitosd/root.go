...
import (
	...
	cmdcfg "github.com/bitdao-io/bitos/cmd/config"
	bitoskr "github.com/bitdao-io/bitos/crypto/keyring"
)
...
// NewRootCmd creates a new root command for bitosd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(bitoskr.Option()).
		WithViper(EnvPrefix)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		bitosApp = app.NewBitos(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := bitosApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		bitosApp = app.NewBitos(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return bitosApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
