...
// source: bitos/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "bitos.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "bitos.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("bitos/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
