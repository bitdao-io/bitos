...
// source: bitos/epochs/v1/genesis.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "bitos.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "bitos.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("bitos/epochs/v1/genesis.proto", fileDescriptor_c74bc0b3e7fa01c2) }
